        ...
        { data && (
          <>
            <div className="flex flex-row justify-center items-center gap-x-8">
              <img src={data.profile.avatar} width={100} className="rounded-full border-tx-light dark:border-tx-dark border-8" />
              <div>
            ...
            <div className="w-full h-full grid grid-cols-1 xl:grid-cols-2 gap-8 xl:gap-16" ref={gridRef}>
              <RecommendationList
